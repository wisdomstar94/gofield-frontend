...
const ProductNewPage = () => {
  return (
    <>
      <Head>
        <title>고필드 - 최근 본 상품</title>
        <meta name="description" content="고필드 최근 본 상품 페이지입니다." />
            ...
            </>} />
          {
            ...
            <div className="w-full relative px-6 py-12">
              <div className="w-full box-sizing flex justify-center items-center">
                <span className="text-black-b text-sm">최근 본 상품 내역이 없습니다.</span>
              </div>
            </div> : <></>
          }
          <GridList>
